...
<form class="w3-container w3-card-4" action="/innerpeace_aaa/member/loginPro" method="post">

<p>
<input class="w3-input" type="text" name="id" style="width:90%" required>
<label>아이디</label></p>
<p>
<input class="w3-input" type="password" name="pwd" style="width:90%" required>
<label>비밀번호</label></p>
...
<button class="w3-button w3-section w3-teal w3-ripple" type="button" 
		onclick="window.location.href='/innerpeace_aaa/member/joinForm'"> 회원가입하기 </button>

<button class="w3-button w3-section w3-teal w3-ripple" type="button" 
		onclick="window.location.href='/innerpeace_aaa/member/index'"> 취소 </button></p>
